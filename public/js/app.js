...
*/
	...
	if(Cookies.get('cookie_webforce') === undefined){
		$('body').append('<div id="cookie_bar" class="cookie_bar">Afin de continuer à améliorer la protection de vos données personnelles, nous avons mis à jour notre <a href="/RGPD">politique de confidentialité</a>.<button id="cookie_btn" class="cookie_btn btn btn-orange">J\'accepte</button></div>');
