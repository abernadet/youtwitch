 ...
 */
final class Version20180730115758 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE chat ADD user_id INT DEFAULT NULL, DROP user');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE chat ADD user VARCHAR(30) NOT NULL COLLATE utf8mb4_unicode_ci, DROP user_id');
    }
}
